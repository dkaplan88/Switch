...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { action: @history.action, devise_id: @history.devise_id, level: @history.level, status: @history.status }
    end
  ...
  test "should update history" do
    put :update, id: @history, history: { action: @history.action, devise_id: @history.devise_id, level: @history.level, status: @history.status }
    assert_redirected_to history_path(assigns(:history))
  end
